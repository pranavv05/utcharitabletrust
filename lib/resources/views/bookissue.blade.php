                ...
                <div class="card">
                    <div class="d-flex flex-row">
                        ...
                        <div class="d-flex flex-column mt-3">
                            <span class="font-weight-bold title">{{ $receiptType }} Receipt</span>
                        </div>
                    </div>
                    <hr>
                            ...
                            <tbody>
                                ...
                                <tr class="content">
                                    <td class="font-weight-bold">{{ $customer->name }}
                                        ...
                                        <br>Order No: {{ $booking->orderNo }}
                                        @if($booking->status === 'new')
                                            <br>Submit Date: {{ $booking->issueDate }}
                                        @else
                                            <br>Validity: {{ $booking->issueDate }} - {{ $booking->endDate }}
                                        @endif
                                    </td>
                    ...
                    <div class="address p-2">
                        <table class="table table-borderless">
                            <tbody>
                                ...
                                <tr>
                                    <td style="width: 50%">
                                        <div style="font-size: 12; font-weight: bold">UT Charitable Address: </div>
                                        <div> Shop.NO.05,
                                            <br> V-Raj Darshan,Samarwani
                                            <br> Silvassa, Dadra And Nagar
                                            <br> Haveli-396230
                                    ...
                                    <td style="width: 50%;text-align:right;">
                                        <div style="font-size: 12; font-weight: bold">Signature: </div>
                                        <br><br><br>
